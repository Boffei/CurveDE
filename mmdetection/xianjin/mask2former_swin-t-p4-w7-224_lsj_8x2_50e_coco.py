...
checkpoint_config = dict(
    interval=100, by_epoch=False, save_last=True, max_keep_ckpts=200)
log_config = dict(
    interval=20,
    hooks=[
...
log_level = 'INFO'
load_from = '/home/Zhaobf/mmdetection-2.28.2/xianjin/line.pth'
resume_from = '/home/Zhaobf/mmdetection-2.28.2/xianjin/line.pth'
workflow = [('train', 5000)]
